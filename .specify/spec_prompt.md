...
then use `setup_spec_environment` to set up the environment/files.

2. **Create the spec feature directory**:
   Specs live under the default `specs/` directory 

3. Load the resolved active `specs/spec-template.md` file to understand required sections.
4. Load `specs/constitution.md` for project principles and governance constraints.
